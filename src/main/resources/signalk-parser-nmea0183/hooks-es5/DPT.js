...
//var debug = require('debug')('signalk-parser-nmea0183/DBT');
...
module.exports = function (parser, input) {
  try {
    ...
    if ((typeof parts[0] !== 'string' || parts[0].trim() == '') && typeof parts[0] !== 'number' || typeof parts[1] !== 'string' && typeof parts[1] !== 'number') {
