...
public class CircularQueue<E>
{
	...
	public static final int CIRCULAR_QUEUE_DEFAULT_SIZE = 20;
    ...
    public CircularQueue() {
    	this(CIRCULAR_QUEUE_DEFAULT_SIZE);
    }
    ...
    public <T> void forEach(Consumer<? super T> var1) {
    ...
    public static void main(String[] args) {
        ...
        CircularQueue<Integer> circularQueue = new CircularQueue<Integer>(100);
